...
if [ -f /opt/shedos-installer/configs/system/zshrc ]; then
    cp /opt/shedos-installer/configs/system/zshrc /home/shedos/.zshrc
    cp /opt/shedos-installer/configs/system/zshrc /root/.zshrc
    chown shedos:shedos /home/shedos/.zshrc
fi

if [ -f /opt/shedos-installer/configs/system/p10k.zsh ]; then
    cp /opt/shedos-installer/configs/system/p10k.zsh /home/shedos/.p10k.zsh
    cp /opt/shedos-installer/configs/system/p10k.zsh /root/.p10k.zsh
    chown shedos:shedos /home/shedos/.p10k.zsh
fi

echo "Zsh configurations deployed"

# Deploy desktop configurations to live user
echo "Deploying desktop configurations..."
if [ -d /opt/shedos-installer/configs ]; then
    ...
    # Fix ownership
    chown -R shedos:shedos "$USER_HOME/.config"
